...
/**
 * Extends the {@link ExpressionManager} supporting mutating operations and the propagation of more variables. Only meant to
 * distinguish the Mule 3 inherited behaviour from the current approach.
 *
 * @since 4.0
 */
